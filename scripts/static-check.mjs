...
if (client.includes('readClient.debugTraceTransaction')) failures.push('unsupported debug trace RPC must not be used')
if (!client.includes('executionErrorDetail(receipt')) failures.push('receipt-only execution error diagnostic missing')
